...
public class ClientGUI extends JFrame implements MessageListener{
    ...
    public ClientGUI(String username) throws ExecutionException, InterruptedException{
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(ClientGUI.this, "Close Application?"
    ...
    private void addChatComponents(){
        ...
        inputField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                if(e.getKeyChar()==KeyEvent.VK_ENTER){
                    ...
                    //edge case (prevent empty message)
        ...
        inputField.setBorder(Utilities.addPadding(0,10, 10, 0));
    ...
    public void onMessageReceive(Message message) {
        ...
        messagePanelScrollPane.getVerticalScrollBar().setValue(Integer.MAX_VALUE);//for auto-scroll
    }
